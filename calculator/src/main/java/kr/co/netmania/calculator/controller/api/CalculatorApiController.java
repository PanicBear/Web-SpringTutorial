package kr.co.netmania.calculator.controller.api;
...
import kr.co.netmania.calculator.dto.CalculatorResult;
import kr.co.netmania.calculator.service.CalculatorService;
...
public class CalculatorApiController {
	...
	// ApiOperation과 ApiResponse는 스웨거의 어노테이션
	// ApiOperation : API에 대한 간단한 설명
	// ApiResponse : 응답 메시지에 대한 명세
